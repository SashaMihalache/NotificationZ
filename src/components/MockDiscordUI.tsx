  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center px-2 text-sm py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
          ...
          <div className="px-2 mb-4">
            <h3 className="text-xs font-semibold text-[#8e9297] px-2 uppercase mb-2">
              Direct Mesages
            </h3>
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Icons.logo className="size-8 mr-3" />
              <span className="font-medium text-sm">NotificationZ</span>
            </div>
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex-1">
            <p className="text-sm medium text-white">You</p>
      ...
      <div className="flex flex-1 flex-col">
        {/* dm header */}
        <div className="h-16 bg-[#39393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">NotificationZ</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              readOnly
              placeholder="Message @NotificationZ"
              type="text"
