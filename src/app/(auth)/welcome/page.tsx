...
const WelcomePage = () => {
  ...
  return (
    <div className="flex w-full flex-1 items-center justify-center px-4 ">
      <BackgroundPattern className="absolute inset-0 left-1/2 top-1/4 z-0 -translate-x-1/2 opacity-90" />
      ...
      <div className="relative z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center">
        ...
        <p className="text-base/7 text-gray-600 max-w-prose">
          Just a moment while we create your account. This should only take a
          few seconds.
        </p>
      </div>
    </div>
